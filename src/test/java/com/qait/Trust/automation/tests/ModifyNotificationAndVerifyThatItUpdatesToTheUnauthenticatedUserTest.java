 ...
 * @author alokkumar
 */
public class ModifyNotificationAndVerifyThatItUpdatesToTheUnauthenticatedUserTest extends TestFundamentals {

    String userName = getProperty("userName");
    String password = getProperty("password");

    String monitorName = null;
    String message = "test of notification for Modified Notification";
    String updatedMessage = "Updated test of notification for Modified Notification";
    String systemView;
    String eventType1 = "Planned Maintenance";
    String eventType2 = "Informational Message";

    @Test
    public void TRUST_598_TC01_Login_With_Admin_User() {
    ...
    @Test
    public void TRUST_598_TC02_Create_Notification_For_Single_System() {
    ...
    @Test
    public void TRUST_598_TC03_Verify_Created_Notification_Displays_To_Unauthenticated_User() {
    ...
    @Test
    public void TRUST_598_TC04_Modify_Notification_And_Verify_Modified_Notification_Displays_To_Unauthenticated_User() {
        test.createAndConfigPage.logAsAdmin(userName, password);
        ...
        test.createNotificationPage.enterValueInCommentSection(updatedMessage);
        test.createNotificationPage.clickOnSaveButton();
        test.detailScreenPage.userNavigateToPlatfromAvailableScreenWhenClickOnPlatformAvailabilityHome();
        test.createAndConfigPage.logOutFromAdmin();
        String splashPageView = test.platformAvailabilityPage.verifyMonitroIsDisplayingOnSplashPage(getData("appNameforRegion.4ltr"), systemView);
        test.createNotificationPage.verifyMessageAndLogoIsDisplayingOrNotDisplayingToUnauthenticatedUser(splashPageView, updatedMessage, eventType2);
    }

    @Test
    public void TRUST_598_TC05_Delete_Created_Notifaction_By_Automation_Script() {
        test.createAndConfigPage.logAsAdmin(userName, password);
        test.createNotificationPage.searchCreatedNotification(updatedMessage);
        test.createNotificationPage.deleteCreatedNotification(updatedMessage);
        test.createAndConfigPage.logOutFromAdmin();
    }
}

 ...
 * @author alokkumar
 */
public class VeridyDisableAutogenedMessageAndShouldNotContinueToGenerateMessagesTest extends TestFundamentals {
    ...
    public void TRUST_603_TC04_Override_Red_System_To_Planned_Maintenance_And_Disable_Autogenerated_Message() {
        ...
        message = " Selecet Planned Maintenance event type and Disable auto generated message ";
        test.createNotificationPage.enterValueInCommentSection(message);

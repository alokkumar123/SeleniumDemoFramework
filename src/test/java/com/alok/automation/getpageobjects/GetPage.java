package com.alok.automation.getpageobjects;

import static com.alok.automation.getpageobjects.ObjectFileReader.getELementFromFile;
...
public class GetPage extends BaseUi {
    ...
    protected boolean isElementDisplayed(String elementName) {
     ...
     protected void waitTOSync(int time) {
        try {
            Thread.sleep(time);
        } catch (Exception e) {
            e.printStackTrace();
